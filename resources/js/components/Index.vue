<template>
  ...
  <div class="flex mt-10 pl-14 pr-14">
    <div class="flex-initial w-5/12 mx-10">
      <h2 class="text-lg font-bold mb-4">Job Recruitments</h2>
      <div v-for="(job, index) in jobs" :key="index" @click="showDetails(index)" class="mt-4 bg-white shadow-lg rounded-lg cursor-pointer transition duration-300 ease-in-out transform hover:-translate-y-1">
        <div class="p-6">
